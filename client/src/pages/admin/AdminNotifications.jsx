...
export default function AdminNotifications() {
  ...
  return (
    <div>
      ...
      <p className="app-muted-text mb-5 text-sm">Create notifications and review delivery history.</p>
      ...
      <form className="admin-card rounded border p-5" onSubmit={sendNotification}>
        <h2 className="app-strong-text mb-4 text-lg font-bold">Create Notification</h2>
        ...
        <button className="mt-5 rounded bg-red-600 px-4 py-2 text-white disabled:opacity-60" disabled={loading} type="submit">{loading ? "Sending..." : "Send Notification"}</button>
      </form>
